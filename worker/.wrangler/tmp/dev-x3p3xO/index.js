...
// .wrangler/tmp/bundle-mSVfAy/strip-cf-connecting-ip-header.js
...
var src_default = {
  async fetch(req, env) {
    ...
    if (pathname.startsWith("/images/")) {
      ...
      if (!key)
        return new Response("Not found", { status: 404, headers: IMAGE_CORS });
      if (req.method === "GET") {
      ...
      if (req.method === "PUT") {
        if (!isAuthed(req, env))
          return new Response("Unauthorized", { status: 401, headers: IMAGE_CORS });
...
// .wrangler/tmp/bundle-mSVfAy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mSVfAy/middleware-loader.entry.ts
